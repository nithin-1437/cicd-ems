...
const navItems = [
  ...
  { href: '/employee-dashboard/leaves', icon: <CalendarCheck />, label: 'Leaves' },
  { href: '/employee-dashboard/payroll', icon: <FileText />, label: 'Payroll' },
];
              ...
              <div className="flex w-full items-center justify-between">
                <div className="flex items-center gap-2">
                  <Avatar className="size-8">
                    ...
                    <AvatarFallback>{user ? getInitials(user.name) : 'E'}</AvatarFallback>
                  </Avatar>
